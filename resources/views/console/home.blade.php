        ...
        <div class="container-fluid">
                ...
                <div class="row bg-white has-shadow">
                    <div class="left-col col-lg-6 d-flex align-items-center justify-content-between">
                        <div class="project-title d-flex align-items-center">
                            <div class="image has-shadow"><img src="{{ asset('images/console/project-1.jpg') }}" alt="..." class="img-fluid"></div>
                            <div class="text">
            ...
            <div class="project">
                <div class="row bg-white has-shadow">
                    <div class="left-col col-lg-6 d-flex align-items-center justify-content-between">
                        <div class="project-title d-flex align-items-center">
                            <div class="image has-shadow"><img src="{{ asset('images/console/project-2.jpg') }}" alt="..." class="img-fluid"></div>
                            <div class="text">
                                <h3 class="h4">Project Title</h3><small>Lorem Ipsum Dolor</small>
                            </div>
                        </div>
            ...
            <div class="project">
                <div class="row bg-white has-shadow">
                    <div class="left-col col-lg-6 d-flex align-items-center justify-content-between">
                        <div class="project-title d-flex align-items-center">
                            <div class="image has-shadow"><img src="{{ asset('images/console/project-3.jpg') }}" alt="..." class="img-fluid"></div>
                            <div class="text">
                                <h3 class="h4">Project Title</h3><small>Lorem Ipsum Dolor</small>
                            </div>
                        </div>
            ...
            <div class="project">
                <div class="row bg-white has-shadow">
                    <div class="left-col col-lg-6 d-flex align-items-center justify-content-between">
                        <div class="project-title d-flex align-items-center">
                            <div class="image has-shadow"><img src="{{ asset('images/console/project-4.jpg') }}" alt="..." class="img-fluid"></div>
                            <div class="text">
                                <h3 class="h4">Project Title</h3><small>Lorem Ipsum Dolor</small>
                            </div>
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="client card">
                        ...
                        <div class="card-body text-center">
                            <div class="client-avatar"><img src="{{ asset('images/console/avatar-2.jpg') }}" alt="..." class="img-fluid rounded-circle">
                ...
                <div class="col-lg-6">
                    <div class="articles card">
                        ...
                        <div class="card-body no-padding">
                            <div class="item d-flex align-items-center">
                                <div class="image"><img src="{{ asset('images/console/avatar-1.jpg') }}" alt="..." class="img-fluid rounded-circle"></div>
                                <div class="text"><a href="#">
                                        <h3 class="h5">Lorem Ipsum Dolor</h3></a><small>Posted on 5th June 2017 by Aria Smith.   </small></div>
                            </div>
                            <div class="item d-flex align-items-center">
                                <div class="image"><img src="{{ asset('images/console/avatar-2.jpg') }}" alt="..." class="img-fluid rounded-circle"></div>
                                <div class="text"><a href="#">
                                        <h3 class="h5">Lorem Ipsum Dolor</h3></a><small>Posted on 5th June 2017 by Frank Williams.   </small></div>
                            </div>
                            <div class="item d-flex align-items-center">
                                <div class="image"><img src="{{ asset('images/console/avatar-3.jpg') }}" alt="..." class="img-fluid rounded-circle"></div>
                                <div class="text"><a href="#">
                                        <h3 class="h5">Lorem Ipsum Dolor</h3></a><small>Posted on 5th June 2017 by Ashley Wood.   </small></div>
                            </div>
                            <div class="item d-flex align-items-center">
                                <div class="image"><img src="{{ asset('images/console/avatar-4.jpg') }}" alt="..." class="img-fluid rounded-circle"></div>
                                <div class="text"><a href="#">
                                        <h3 class="h5">Lorem Ipsum Dolor</h3></a><small>Posted on 5th June 2017 by Jason Doe.   </small></div>
                            </div>
                            <div class="item d-flex align-items-center">
                                <div class="image"><img src="{{ asset('images/console/avatar-5.jpg') }}" alt="..." class="img-fluid rounded-circle"></div>
                                <div class="text"><a href="#">
                        ...
                        <div class="card-body no-padding">
                            ...
                            <div class="item">
                                <div class="feed d-flex justify-content-between">
                                    <div class="feed-body d-flex justify-content-between"><a href="#" class="feed-profile"><img src="{{ asset('images/console/avatar-5.jpg') }}" alt="person" class="img-fluid rounded-circle"></a>
                                        <div class="content">
                            ...
                            <div class="item">
                                <div class="feed d-flex justify-content-between">
                                    <div class="feed-body d-flex justify-content-between"><a href="#" class="feed-profile"><img src="{{ asset('images/console/avatar-2.jpg') }}" alt="person" class="img-fluid rounded-circle"></a>
                                        <div class="content">
                            ...
                            <div class="item clearfix">
                                <div class="feed d-flex justify-content-between">
                                    <div class="feed-body d-flex justify-content-between"><a href="#" class="feed-profile"><img src="{{ asset('images/console/avatar-3.jpg') }}" alt="person" class="img-fluid rounded-circle"></a>
                                        <div class="content">
